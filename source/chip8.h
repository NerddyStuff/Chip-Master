...
{       
    private:
        ...
        uint8_t memory[MEMORY]{};         //4096kb of memory
        ...
        Chip8Function MasterTable[0xF + 1]{&Chip8::NullOpcode};
        Chip8Function TableOf0[0xE + 1]{&Chip8::NullOpcode};
        Chip8Function TableOf8[0xE + 1]{&Chip8::NullOpcode};
        Chip8Function TableOfE[0xE + 1]{&Chip8::NullOpcode};
        Chip8Function TableOfF[0x65 + 1]{&Chip8::NullOpcode};
